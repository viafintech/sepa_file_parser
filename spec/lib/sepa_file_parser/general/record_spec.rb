...
RSpec.describe SepaFileParser::Record do
  ...
  specify { expect(ex_charges.records[0].type).to be_kind_of(SepaFileParser::Type::Proprietary) }
  ...
  specify { expect(ex_charges.records[1].type).to be_kind_of(SepaFileParser::Type::Code) }
